...
#include "UserData.h"
	...
	#else
		#ifndef _DLL_EXPORT_
			#define _DLL_EXPORT_ extern "C" __attribute__( ( visibility("default") ) )	
		#endif
	#endif

	#define GMOD_MODULE_OPEN()	_DLL_EXPORT_ int gmod13_open( lua_State* L )
	#define GMOD_MODULE_CLOSE()	_DLL_EXPORT_ int gmod13_close( lua_State* L )
